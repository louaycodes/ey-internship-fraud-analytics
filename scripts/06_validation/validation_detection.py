...
INPUT_DIR = os.path.join(BASE_DIR, "../../tests/test1_generalisation/resultats")
JOURNAL_PATH = os.path.join(BASE_DIR, "../../tests/test1_generalisation/data", "journal_fraudes_injectees.csv")
